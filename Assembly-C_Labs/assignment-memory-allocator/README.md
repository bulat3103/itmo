...
- [Исходный код одной из последних версий аллокатора в `glibc`. Очень много хорошо написанных комментариев](IdeaProjects/Assembly-c_labs/Assembly-C_Labs/assignment-memory-allocator/docs/malloc-impl.c)
